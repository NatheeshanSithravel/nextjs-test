...
import { findManagerAssignedTemplates, retriewAllAvailableItinerary, retriewAllTemplatesToApprove } from '@/app/(services)/SFARestClient';
...
import TemplateDialog from './(component)/TemplateDialog';
...
export default function Page() {
    ...
    ////////////// init //////////////////
    const init = async () => {
        const res = await findManagerAssignedTemplates(token, { tokenString: token, templateStatus: status })
    ...
    return (
        <PageContent title='Approve Itinerary Template'>
                        ...
                        {globaleTemplateDTO
                            ...
                            .map((row: any, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{row.itinTemplateDateMapList[0]?.userId}</TableCell>
                                    <TableCell>
